# CALVIZA - Complete Research Dossier
...
- **Aura Description:** lucid, inquisitive
...
### Themes
Virtues: holistic perception, fearless inquiry Vices: tunnel-vision, analytic arrogance.
...
*Prioritized questions for systematic exploration of CALVIZA's nature and applications*
...
- Explore core domains: optics, ophidian herb-work
- Investigate practical applications of CALVIZA's expertise
- Document unique perspectives and wisdom
- Gather specific examples and case studies

### Recommended Approach
1. **Opening:** Begin with CALVIZA's essence and primary nature
2. **Domain Exploration:** Focus on optics
...
- **Personality Expression:** How lucid, inquisitive, tri-perspectival manifests in practice
...
- "CALVIZA, I'm seeking to understand your essence as Bearer of **triple-sight**-past, present, future refracted in a single ray.. How would you introduce yourself to someone new to your wisdom?"
- "Your expertise in optics is renowned. What would you want newcomers to understand first about this domain?"
...
*This dossier provides a comprehensive foundation for systematic research and character interaction with CALVIZA. Use it as a guide for structured AI roleplay sessions to expand the Enochian Governor lore database.* 